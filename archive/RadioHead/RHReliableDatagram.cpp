...
////////////////////////////////////////////////////////////////////
// Constructors
RHReliableDatagram::RHReliableDatagram(RHGenericDriver& driver, uint16_t thisAddress)
...
////////////////////////////////////////////////////////////////////
bool RHReliableDatagram::sendtoWait(uint8_t* buf, uint8_t len, uint16_t address)
{
...
////////////////////////////////////////////////////////////////////
bool RHReliableDatagram::recvfromAck(uint8_t* buf, uint8_t* len, uint16_t* from, uint16_t* to, uint8_t* id, uint8_t* flags)
{
    uint16_t _from;
    uint16_t _to;
    uint8_t _id;
...
bool RHReliableDatagram::recvfromAckTimeout(uint8_t* buf, uint8_t* len, uint16_t timeout, uint16_t* from, uint16_t* to, uint8_t* id, uint8_t* flags)
{
...
void RHReliableDatagram::acknowledge(uint8_t id, uint16_t from)
{
    setHeaderId(id);
