...
void RHGenericDriver::setThisAddress(uint16_t address)
{
    _thisAddress = address;
}

void RHGenericDriver::setHeaderTo(uint16_t to)
{
    _txHeaderTo = to;
}

void RHGenericDriver::setHeaderFrom(uint16_t from)
{
    _txHeaderFrom = from;
}
...
uint16_t RHGenericDriver::headerTo()
{
    return _rxHeaderTo;
}

uint16_t RHGenericDriver::headerFrom()
{
