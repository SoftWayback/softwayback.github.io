...
////////////////////////////////////////////////////////////////////
// Constructors
RHRouter::RHRouter(RHGenericDriver& driver, uint16_t thisAddress)
...
////////////////////////////////////////////////////////////////////
void RHRouter::addRouteTo(uint16_t dest, uint8_t next_hop, uint8_t state)
{
...
////////////////////////////////////////////////////////////////////
RHRouter::RoutingTableEntry* RHRouter::getRouteTo(uint16_t dest)
{
  //?
    uint8_t i;
    for (i = 0; i < RH_ROUTING_TABLE_SIZE; i++)
...
////////////////////////////////////////////////////////////////////
bool RHRouter::deleteRouteTo(uint16_t dest)
{
  //?
    uint8_t i;
    for (i = 0; i < RH_ROUTING_TABLE_SIZE; i++)
...
//?
uint8_t RHRouter::sendtoWait(uint8_t* buf, uint8_t len, uint16_t dest, uint8_t flags)
{
...
//?
uint8_t RHRouter::sendtoFromSourceWait(uint8_t* buf, uint8_t len, uint16_t dest, uint16_t source, uint8_t flags)
{
...
uint8_t RHRouter::route(RoutedMessage* message, uint8_t messageLen)
{
    ...
    uint16_t next_hop = RH_BROADCAST_ADDRESS;
...
////////////////////////////////////////////////////////////////////
bool RHRouter::recvfromAck(uint8_t* buf, uint8_t* len, uint16_t* source, uint16_t* dest, uint8_t* id, uint8_t* flags)
{
...
////////////////////////////////////////////////////////////////////
bool RHRouter::recvfromAckTimeout(uint8_t* buf, uint8_t* len, uint16_t timeout, uint16_t* source, uint16_t* dest, uint8_t* id, uint8_t* flags)
{
