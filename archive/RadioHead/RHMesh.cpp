...
////////////////////////////////////////////////////////////////////
// Constructors
RHMesh::RHMesh(RHGenericDriver& driver, uint16_t thisAddress)
...
uint8_t RHMesh::sendtoWait(uint8_t* buf, uint8_t len, uint16_t address, uint8_t flags)
{
...
////////////////////////////////////////////////////////////////////
bool RHMesh::doArp(uint16_t address)
{
...
{
    uint16_t from = headerFrom(); // Might get clobbered during call to superclass route()
    //?
...
//?
bool RHMesh::isPhysicalAddress(uint16_t* address, uint8_t addresslen)
{
...
////////////////////////////////////////////////////////////////////
bool RHMesh::recvfromAck(uint8_t* buf, uint8_t* len, uint16_t* source, uint16_t* dest, uint8_t* id, uint8_t* flags)
{
...
////////////////////////////////////////////////////////////////////
bool RHMesh::recvfromAckTimeout(uint8_t* buf, uint8_t* len, uint16_t timeout, uint16_t* from, uint16_t* to, uint8_t* id, uint8_t* flags)
{
    unsigned long starttime = millis();
    int32_t timeLeft;
